...
//     }
//
//     for sound_buffer_index in 0..AUDIO_ENGINE_SOUND_BUFFER.len() {
//         let sound_buffer = &mut AUDIO_ENGINE_SOUND_BUFFER[sound_buffer_index];
...
//
//             let buffer: [c_uchar; 1024] = ['\0' as u_char; 1024];
//             let mut pos = 0;
//             while pos < length {
