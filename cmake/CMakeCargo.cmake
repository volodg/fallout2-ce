function(cargo_build)
    ...
    if(WIN32)
        if(CMAKE_VS_PLATFORM_NAME MATCHES ARM64)
            set(LIB_TARGET "aarch64-pc-windows-msvc")
    ...
    elseif(ANDROID)
        if(CMAKE_ANDROID_ARCH_ABI STREQUAL "armeabi-v7a")
            set(LIB_TARGET "armv7-linux-androideabi")
        elseif(ANDROID_SYSROOT_ABI STREQUAL "x86" OR CMAKE_ANDROID_ARCH_ABI STREQUAL "x86")
            set(LIB_TARGET "i686-linux-android")
        elseif(ANDROID_SYSROOT_ABI STREQUAL "x86_64" OR CMAKE_ANDROID_ARCH_ABI STREQUAL "x86_64")
            set(LIB_TARGET "x86_64-linux-android")
        elseif(ANDROID_SYSROOT_ABI STREQUAL "arm" OR CMAKE_ANDROID_ARCH_ABI STREQUAL "arm")
            set(LIB_TARGET "arm-linux-androideabi")
        elseif(ANDROID_SYSROOT_ABI STREQUAL "arm64" OR CMAKE_ANDROID_ARCH_ABI STREQUAL "arm64" OR CMAKE_ANDROID_ARCH_ABI STREQUAL "arm64-v8a")
